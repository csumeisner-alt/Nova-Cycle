...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            // Locally, without those env vars, the release build falls back to the
            // auto-generated debug keystore so a full local rebuild still produces a
            // working, installable APK for testing.
            ...
            if (keystoreBase64 != null && keystorePassword != null &&
                ...
                // Local fallback: debug keystore (auto-generated by AGP on first build)
