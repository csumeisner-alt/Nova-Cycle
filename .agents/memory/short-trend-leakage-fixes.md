...
- Rule: a calibrated rare-event probability must be centered in the short gauge on its OOS positive/base rate, not 0.5; preserve 0.5 only for missing-model fallbacks. Otherwise normal 5–15% probabilities create a persistent bearish bias.
