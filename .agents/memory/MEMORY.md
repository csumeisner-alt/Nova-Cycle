...
- [Android Auto Backup rules](android-auto-backup-rules.md) — backup rule files use explicit includes; new durable stores must be added to both xml files or they're lost on reinstall
