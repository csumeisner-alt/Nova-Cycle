...
- Local release APK packaging needs Android SDK + Java 17 and cannot use CI keystore secrets; a debug-signing fallback is suitable for local/test distribution, while CI must keep the protected release key for update compatibility.
